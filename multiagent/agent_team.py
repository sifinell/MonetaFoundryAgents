...
class AgentTeam:
    ...
    def add_existing_agent(self, agent: Agent, can_delegate: bool = True) -> None:
        """
        Add an existing agent to this AgentTeam.
    ...
    def dismantle_team(self) -> None:
        ...
        # Commented to only delete the team leader
        """
        for member in self._members:
